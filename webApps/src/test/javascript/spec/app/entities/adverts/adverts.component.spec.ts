...
import { AdvertsComponent } from 'app/entities/adverts/adverts.component';
import { AdvertsService } from 'app/entities/adverts/adverts.service';
import { Adverts } from 'app/shared/model/adverts.model';

describe('Component Tests', () => {
    describe('Adverts Management Component', () => {
        let comp: AdvertsComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AdvertsComponent, '')
                .compileComponents();
