...
import { StockTypeComponent } from 'app/entities/stock-type/stock-type.component';
...
describe('Component Tests', () => {
    describe('StockType Management Component', () => {
        let comp: StockTypeComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(StockTypeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.stockTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
