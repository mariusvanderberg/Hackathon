    ...
    describe('ContactInfo Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/contact-infos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a ContactInfo', () => {
                service.create(new ContactInfo(null)).subscribe(received => {
            ...
            it('should update a ContactInfo', () => {
                service.update(new ContactInfo(123)).subscribe(received => {
            ...
            it('should return a ContactInfo', () => {
