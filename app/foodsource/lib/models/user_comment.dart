...
class UserComment extends BaseEntity {
  @override
...
//        super.map['employee'].map['user'] = employee.user.toMap();
//      }
    }

//    if (employee.user != null) {
//      super.map['employee.user'] = employee.user.toMap();
//    }

    if (employeeUser != null) {
      super.map['employeeUser'] = employeeUser.toMap();
    }
  ...
  fromMap(Map map) {
    ...
    if (map.containsKey('employee') && map['employee'] != null) {
      ...
      if (employeeMap.containsKey('user') && employeeMap['user'] != null) {
        var employeeUserMap = employeeMap['user'];
        employeeUser = new User();
        employeeUser.fromMap(employeeUserMap);
        employee.user = employeeUser;
        employee.userId = employeeUser.id;
      }
    }

//    if (map.containsKey('employee.user') && map['employee.user'] != null) {
//      var employeeUserMap = map['employee.user'];
//      employeeUser = new User();
//      employeeUser.fromMap(employeeUserMap);
//      employee.userId = employeeUser.id;
//    }
